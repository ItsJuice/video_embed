...
describe VideoEmbed do
  describe 'YouTube' do
    it 'returns embed html from a url' do
      ...
      video_embed.should eql(%Q{<iframe width="560" height="315" src="https://www.youtube.com/embed/4Z3r9X8OahA?rel=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>})
    end

    it 'returns embed html from a short url' do
      video_embed = VideoEmbed.embed('http://youtu.be/4Z3r9X8OahA')
      video_embed.should include('https://www.youtube.com/embed/4Z3r9X8OahA?rel=0')
    end
