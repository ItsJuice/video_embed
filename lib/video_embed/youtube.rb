...
class VideoEmbed
  class YouTube
    ...
    class Url
      ...
      def embed
        %Q{<iframe width="#{width}" height="#{height}" src="https://www.youtube-nocookie.com/embed/#{video_id}?rel=0&modestbranding=1" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen#{html_attributes}></iframe>}
      end
